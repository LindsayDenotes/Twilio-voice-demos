$(function () {
  ...
  $.getJSON('https://magnolia-cat-4216.twil.io/capability-token')
    .done(function (data) {
      log('Got a token.');
      console.log('ln 12 quickstart: Token: ' + data.token);
  ...
  document.getElementById('button-call').onclick = function () {
    ...
    console.log('ln 74 quickstart: Calling ' + params.To + '...');
  ...
  speakerDevices.addEventListener('change', function() {  // ~ good use of es6 filter and map
